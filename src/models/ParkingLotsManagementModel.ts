...
export default class ParkingLotsManagementModel {
    ...
    fieldsToDisplay (): headerObj[] {
        ...
        return [
            { field: DELIVERYLOCATION_NM.field, label: DELIVERYLOCATION_NM.label, type: 'text', width: "100px" },
            { field: LOT_ID.field, label: LOT_ID.label, type: 'text' },
            { field: CUSTOMER_NAME.field, label: CUSTOMER_NAME.label, type: 'text', width: "100px" },
            { field: LOT_CONTACT.field, label: LOT_CONTACT.label, type: 'text' },
            { field: STREET_ADDRESS.field, label: STREET_ADDRESS.label, type: 'text', width: "150px" },
            ...
            { field: RACK_UPDATE.field, label: RACK_UPDATE.label, type: 'text', width: "150px" },
            {
