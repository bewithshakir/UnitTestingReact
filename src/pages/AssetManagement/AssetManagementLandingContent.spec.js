...
describe('Rendering of Asset Management landing page Component', () => {
    const component = mount(<QueryClientProvider client={queryClient}><AssetManagementLandingContent version='1' /></QueryClientProvider>);
    ...
    it('Search Textbox Data Enter ', () => {
        const component = shallow(<QueryClientProvider client={queryClient}><AssetManagementLandingContent onChange={() => jest.fn()} /></QueryClientProvider>);
