...
import { useGetStates, useGetCity } from './queries';
import { AddOpisCitiesValidation, formStatusObj } from './validation';
                        ...
                        <Container maxWidth="lg" className="page-container">
                                ...
                                <Grid item xs={8} md={10} pr={2.5} pb={2.5}>
                                    <Grid item xs={12} md={6}>
                                        <Input
                                            ...
                                            helperText={(formik.touched.city && formik.errors.city) ? formik.errors.cityid : undefined}
                                            error={(formik.touched.city && formik.errors.city) ? true : false}
                                            description=''
                            ...
                            <Grid container mt={1} justifyContent="flex-start">
                                <Grid item xs={6} md={8} pr={2.5} pt={2.5}>
                                    ...
                                    <ToastMessage isOpen={false} messageType={formStatus.type} onClose={() => { return ''; }} message={formStatus.message} />
                                </Grid>
                            </Grid>
                        </Container>
                    </Grid>
