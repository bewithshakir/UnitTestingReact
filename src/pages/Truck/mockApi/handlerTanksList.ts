...
export const getTanksList = () => {
    return rest.get('*/api/truck-service/delivery-vehicles/a8898131-5add-4b76-aa92-8c7521bcb829/tanks*', (req, res, ctx) => {
        return res(
            ctx.status(200),
            ctx.json({
                data: {
                    ...
                    "tanks": [
                        {
                            "deliveryVehicleId": "a8898131-5add-4b76-aa92-8c7521bcb829",
