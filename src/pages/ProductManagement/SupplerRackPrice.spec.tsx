...
import SupplerRackPrice from './SupplerRackPrice';
...
describe('Rendering of supplier rack price', () => {
    it('should render snapshot for supplier rack price', () => {
        const component = mount(<ReactQuery.QueryClientProvider client={queryClient}> <SupplerRackPrice formik={mockFormik} isDisabled={false} setSupplierPrice={jest.fn()} /> </ReactQuery.QueryClientProvider >);
