                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            <Grid container mt={1}>
                                <Grid item md={12} mt={2} mb={1}>
                                    <Typography color="var(--Darkgray)" variant="h4" component="h4" gutterBottom className="fw-bold" mb={1}>
                                        General Information
                                    </Typography>
                                </Grid>
                                    ...
                                    <FormControl sx={{ m: 3 }}>
                                        <FormGroup>
                                            <FormControlLabel
                                                ...
                                                label={
                                                    <Typography color="var(--Darkgray)" variant="h4" component="h4" className="fw-bold">
                                                        Apply at Lot level
                                                    </Typography>
                                                }
                                            />
                                ...
                                <Grid item md={12} mt={2} mb={1}>
                                    <Box className="import-file">
                                        <FileCopy />
                                        <Typography color="var(--Darkgray)" variant="h4" component="h4" display={"inline-flex"} className="fw-bold pl-3" mb={1}>
                                            Import Contract (Optional)
                                        </Typography>
                                    </Box>
                                </Grid>
