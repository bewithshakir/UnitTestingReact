...
import { getDelFeeSchduleHandler, getProductTypeHandler, getVehicleTypeHandler, getAssetTypeHandler, getLotProductNamesHandler, addFeeDetailsHandler, getFeeDetailsHandler, editFeeDetailsHandler } from '../pages/ParkingLot/FeeDetails/mockAPi/handler';
...
import { getProductHandler } from '../mockAPI/productService/GET';
import { postProductHandler } from '../mockAPI/productService/POST';
import { putProductHandler } from '../mockAPI/productService/PUT';
