...
describe('renders the Default Select component', () => {
    const component = shallow(<Select label='Input' items={[{label:'Label', value: 'Value', icon: <YellowFuelIcon/>}]} onChange={() => jest.fn()}/>);
...
describe('renders the SingleSelect component with error ', () => {
    const component = shallow(<Select label='Input' error={true} value={{ label: 'Label1', value: 'Value1' , icon: <YellowFuelIcon/>}} items={[{ label: 'Label1', value: 'Value1' , icon: <YellowFuelIcon/>}, { label: 'Label2', value: 'Value2', icon: <YellowFuelIcon/> }, { label: 'Label3', value: 'Value3', icon: <YellowFuelIcon/> }]} onChange={() => jest.fn()} />);
...
describe('renders the SingleSelect component with required prop', () => {
    const component = shallow(<Select label='Input' required  value={{ label: 'Label1', value: 'Value1' , icon: <YellowFuelIcon/>}} items={[{ label: 'Label1', value: 'Value1' , icon: <YellowFuelIcon/>}, { label: 'Label2', value: 'Value2', icon: <YellowFuelIcon/> }, { label: 'Label3', value: 'Value3', icon: <YellowFuelIcon/> }]} onChange={() => jest.fn()} />);
...
describe('renders the SingleSelect component with helper text', () => {
    const component = shallow(<Select label='Input' required helperText={'sample error'}  value={{ label: 'Label1', value: 'Value1' , icon: <YellowFuelIcon/>}} items={[{ label: 'Label1', value: 'Value1' , icon: <YellowFuelIcon/>}, { label: 'Label2', value: 'Value2', icon: <YellowFuelIcon/> }, { label: 'Label3', value: 'Value3', icon: <YellowFuelIcon/> }]} onChange={() => jest.fn()} />);
